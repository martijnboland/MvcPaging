...
namespace MvcPaging
{
    public class Pager
    {
        ...
        private readonly int nrOfPagesToDisplay;

        public Pager(ViewContext viewContext, int pageSize, int currentPage, int totalItemCount, RouteValueDictionary valuesDictionary, AjaxOptions ajaxOptions, int numberOfPagesToDisplay)
        {
            ...
            this.nrOfPagesToDisplay = numberOfPagesToDisplay;
        }

        public HtmlString RenderHtml()
        {
            var pageCount = (int)Math.Ceiling(totalItemCount / (double)pageSize);
            //const int nrOfPagesToDisplay = 8;
